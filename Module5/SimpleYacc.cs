...
// DateTime: 20.12.2019 19:20:34
// UserName: user
// Input file <SimpleYacc.y - 20.12.2019 19:20:31>
...
{
  // Verbatim content from SimpleYacc.y - 20.12.2019 19:20:31
// Ýòè îáúÿâëåíèÿ äîáàâëÿþòñÿ â êëàññ GPPGParser, ïðåäñòàâëÿþùèé ñîáîé ïàðñåð, ãåíåðèðóåìûé ñèñòåìîé gppg
    public Parser(AbstractScanner<int, LexLocation> scanner) : base(scanner) { }
  // End verbatim content from SimpleYacc.y - 20.12.2019 19:20:31
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "repeat", "while", "if", "write", "var", "identlist", "ident", "expr", 
      "e1", "e2", "e3", };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-4,5,-5,41,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-28);
    states[7] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,8,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{9,11});
    states[11] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,12,-16,13,-17,25,-18,28,-14,18});
    ...
    states[14] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-17,15,-18,28,-14,18});
    ...
    states[16] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-18,17,-14,18});
    states[17] = new State(-22);
    states[18] = new State(-24);
    states[19] = new State(-15);
    states[20] = new State(-25);
    states[21] = new State(-26);
    states[22] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,23,-16,13,-17,25,-18,28,-14,18});
    ...
    states[26] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-18,27,-14,18});
    states[27] = new State(-23);
    states[28] = new State(-21);
    states[29] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-17,30,-18,28,-14,18});
    ...
    states[33] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,34,-16,13,-17,25,-18,28,-14,18});
    states[34] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,35,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[35] = new State(-29);
    states[36] = new State(-8);
    states[37] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-4,38,-5,41,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[38] = new State(new int[]{12,39,10,7});
    states[39] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,40,-16,13,-17,25,-18,28,-14,18});
    states[40] = new State(-30);
    states[41] = new State(-3);
    states[42] = new State(-9);
    states[43] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,44,-16,13,-17,25,-18,28,-14,18});
    states[44] = new State(new int[]{14,45});
    states[45] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,46,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[46] = new State(-31);
    states[47] = new State(new int[]{8,19},new int[]{-6,48,-14,10});
    states[48] = new State(new int[]{19,49});
    states[49] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,50,-16,13,-17,25,-18,28,-14,18});
    states[50] = new State(new int[]{14,51});
    states[51] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,52,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[52] = new State(-34);
    states[53] = new State(-10);
    states[54] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,55,-16,13,-17,25,-18,28,-14,18});
    states[55] = new State(new int[]{16,56});
    states[56] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,57,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[57] = new State(new int[]{17,58,4,-32,10,-32,12,-32});
    states[58] = new State(new int[]{8,19,3,4,5,33,11,37,13,43,18,47,15,54,22,61,23,66},new int[]{-5,59,-6,9,-14,10,-3,31,-7,32,-8,36,-9,42,-10,53,-11,60,-12,65});
    states[59] = new State(-33);
    states[60] = new State(-11);
    states[61] = new State(new int[]{20,62});
    states[62] = new State(new int[]{8,19,6,20,7,21,20,22},new int[]{-15,63,-16,13,-17,25,-18,28,-14,18});
    states[63] = new State(new int[]{21,64});
    states[64] = new State(-35);
    states[65] = new State(-12);
    states[66] = new State(new int[]{8,68},new int[]{-13,67});
    states[67] = new State(-36);
    states[68] = new State(new int[]{24,69,4,-13,10,-13,12,-13,17,-13});
    states[69] = new State(new int[]{8,68},new int[]{-13,70});
    ...
    rules[14] = new Rule(-13, new int[]{8,24,-13});
    rules[15] = new Rule(-14, new int[]{8});
    ...
    rules[24] = new Rule(-18, new int[]{-14});
    ...
    rules[36] = new Rule(-12, new int[]{23,-13});
  }
